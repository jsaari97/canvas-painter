...
var CanvasPainter = function CanvasPainter(_ref) {
  ...
  this.onMouseDown = function (e) {
    ...
    _this.tempElement.addEventListener('mouseleave', _this.onMouseUp, false);
  ...
  this.onMouseUp = function (e) {
    ...
    _this.tempElement.removeEventListener('mouseleave', _this.onMouseUp, false);
  ...
  this.init = function () {
    if (_this.role !== 'painter') {
      if (_this.role === 'guesser') {
        window.removeEventListener('onDraw', _this.onDrawEvent, false);
        window.removeEventListener('onEnd', _this.applyStroke, false);
      }
  ...
  this.clearCanvas = function () {
    _this.context.clearRect(0, 0, element.width, element.height);
    _this.count = 0;
    _this.points = [];
  };

  this.onDrawEvent = function (e) {
    _this.points.push(e.detail);
    _this.Paint();
  };
  ...
  this.watch = function () {
    if (_this.role !== 'guesser') {
      if (_this.role === 'painter') {
        _this.tempElement.removeEventListener('mousedown', _this.onMouseDown, false);
        _this.tempElement.removeEventListener('mouseup', _this.onMouseUp, false);
      }
      window.addEventListener('onDraw', _this.onDrawEvent, false);
      window.addEventListener('onEnd', _this.applyStroke, false);
      _this.role = 'guesser';
    }
  };
};
